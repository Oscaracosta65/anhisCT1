 ...
 * - Secure query handling with Joomla query builder
 *
...
if (isset($stateName, $gName) && $stateName !== '' && $gName !== '') {
    ...
    $metaDesc = 'Frequency analysis, draw history, and recency data for ' . $stateName . ' ' . $gName . '. Review active numbers, quiet stretches, and full historical frequency at LottoExpert.net.';
...
function leFmtDateLong(?string $date): string
{
    ...
    return ($ts === false) ? '&mdash;' : date('F j, Y', $ts);
}
...
/**
 * CT1 Pick-6: repeated numbers check across all 6 positions.
 */
...
/**
 * CT1 Pick-6: previous occurrence searches all 6 positions (same pool).
 * The $isBonus parameter is accepted for compatibility but not applied
 * since all positions share the same 01-44 pool.
 */
 ...
 * All 6 balls checked across all 6 positions (same pool).
 * --------------------------------------------------------------------------
 */
$drawHistoryRows = [];
...
$overviewNote = 'Frequency shows historical occurrence within the selected window. For this game, all six drawn numbers come from the same pool (01&ndash;44), so all positions are analyzed together as one distribution. Use this as descriptive context, not prediction.';
 ...
 * --------------------------------------------------------------------------
 */
$jsonLdName = isset($stateName, $gName) ? ((string) $stateName . ' ' . (string) $gName . ' Lottery Analysis') : 'Lottery Analysis';
$jsonLdDesc = isset($stateName, $gName) ? ('Frequency analysis, draw history, and recency data for ' . (string) $stateName . ' ' . (string) $gName . '.') : 'Frequency analysis and draw history.';
$jsonLdUrl  = htmlspecialchars($canonicalNoQuery, ENT_QUOTES, 'UTF-8');
?>
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","name":"<?php echo htmlspecialchars($jsonLdName, ENT_QUOTES, 'UTF-8'); ?>","description":"<?php echo htmlspecialchars($jsonLdDesc, ENT_QUOTES, 'UTF-8'); ?>","url":"<?php echo $jsonLdUrl; ?>","inLanguage":"en","publisher":{"@type":"Organization","name":"LottoExpert.net","url":"https://lottoexpert.net"}}
</script>
<style>
:root{
  --skai-blue:#1C66FF;
      ...
      <div class="skai-hero-top">
        ...
        <div class="skai-hero-copy">
          ...
          <div class="skai-hero-actions" aria-label="Primary actions">
            <a class="skai-btn skai-btn--primary" href="/picking-winning-numbers/artificial-intelligence/skai-lottery-prediction?gameId=CT1">
              Open SKAI Analysis
            </a>
            <a class="skai-btn skai-btn--secondary" href="/picking-winning-numbers/artificial-intelligence/ai-powered-predictions?game_id=CT1">
              AI Predictions
            </a>
          ...
          <div class="skai-meta-stack">
            <div class="skai-meta-row">
              <div class="skai-meta-box">
                ...
                <span class="value"><?php echo leFmtDateLong($drawDate); ?></span>
              </div>
              <div class="skai-meta-box">
                <span class="label">Next draw date</span>
                <span class="value"><?php echo leFmtDateLong($nextDrawDate); ?></span>
              </div>
            </div>
  ...
  <section class="skai-strip" aria-label="Key takeaways">
    <article class="skai-stat">
      ...
      <div class="skai-stat-body">
        ...
        <div class="skai-stat-note">Highest appearance counts in the current <?php echo (int) $nodCurrentMain; ?>-draw window across all six positions.</div>
      </div>
    </article>
    ...
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          Start with a clear high-level view. This layer is designed for fast orientation: which numbers are most active across all six positions, which are quiet, and how the current draw relates to recent history.
        </p>
      </div>
    </div>
      ...
      <div class="skai-overview-grid">
        <div class="skai-card">
          <div class="skai-card-head skai-card-head--horizon">
            Top active numbers
            <span class="skai-card-sub">Highest frequency counts in the last <?php echo (int) $nodCurrentMain; ?> drawings across all six positions</span>
          </div>
  ...
  <section id="recency-deep-dive" class="skai-section" aria-labelledby="recency-title">
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          This section makes the current draw easier to interpret. It shows how recently each of the six latest drawn numbers was previously seen in any position, and how the perspective shifts when comparing a short recent window with a broader historical one.
        </p>
      </div>
    </div>
  ...
  <section id="frequency-deep-dive" class="skai-section" aria-labelledby="frequency-title">
    ...
    <div class="skai-section-body">
      <div class="skai-two-col">
        <div class="skai-card">
          <div class="skai-card-head skai-card-head--horizon">
            Full number distribution — all positions
            <span class="skai-card-sub">All values 01&ndash;44, all six positions, last <?php echo (int) $nodCurrentMain; ?> drawings</span>
          </div>
          <div class="skai-card-body">
            <div class="skai-chart-shell">
        ...
        <div class="skai-grid">
          ...
          <div class="skai-card">
            <div class="skai-card-head skai-card-head--ember">
              ...
              <span class="skai-card-sub">Distance since last appearance for each number (all positions)</span>
            </div>
            <div class="skai-card-body">
              <div class="skai-chart-shell">
                <div class="skai-chart-frame">
      ...
      <div class="skai-tool-grid">
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/skai-lottery-prediction?gameId=CT1">Open SKAI Analysis</a>
          </div>
        </article>
        ...
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/ai-powered-predictions?game_id=CT1">Open AI Predictions</a>
          </div>
        </article>
        ...
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/skip-and-hit-analysis?game_id=CT1">Open Skip &amp; Hit</a>
          </div>
        </article>
      </div>

      <div class="skai-utility-grid">
        <a class="skai-utility-link" href="/picking-winning-numbers/artificial-intelligence/markov-chain-monte-carlo-mcmc-analysis?game_id=CT1">MCMC Markov Analysis</a>
        <a class="skai-utility-link" href="/all-lottery-heatmaps?gameId=CT1">Heatmap Analysis</a>
